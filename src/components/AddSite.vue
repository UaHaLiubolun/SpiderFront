        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="名称">
              <el-input  v-model="siteTask.name"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="5">
            <el-form-item label="来源" :label-width="formLabelWidth">
              <template>
                <el-select v-model="siteTask.source" filterable placeholder="请选择(可搜索)">
                  <el-option
          ...
          <el-col :span="5">
            <el-form-item label="分类" :label-width="formLabelWidth">
              <template>
                <el-select v-model="siteTask.type" filterable placeholder="请选择(可搜索)">
                  <el-option
                    v-for="item in types"
                    :key="item.value"
                    :label="item.value"
